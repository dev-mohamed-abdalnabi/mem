...
export default function SavesPage({
  ...
  return (
    ...
    <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto animate-fade-in pb-20 lg:pb-8 px-4 md:px-0">  
      ...
      {savedMemes.length === 0 ? (  
        <div className="text-center py-12 text-gray-400 font-bold bg-white dark:bg-gray-900 rounded-2xl md:rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm">
