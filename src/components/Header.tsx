        ...
        <div ref={dropdownContainerRef} className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className={`h-10 pl-1 pr-3 flex items-center gap-2 rounded-full border transition-colors cursor-pointer ${
                showUserDropdown 
                  ? "bg-gray-300 dark:bg-gray-600 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white" 
            ...
            >
              ...
              {isRealUser && currentUser.avatar_url ? (
                ...
                <div className="w-10 h-10 rounded-full text-gray-500 dark:text-gray-300 flex items-center justify-center text-xs font-black shrink-0">
